...
public class TelepertorObject : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if(playerController!=null&&playerController.isActiveAndEnabled)
        {
            ...
            Debug.LogFormat("TeleporterObject:Character[{0}] Ebter Teleporter[{1}:{2}]", playerController.character.Info.Name, td.ID, td.Name);
